				...
				<form class="form-signin" action="/FarmaWeb/cadastrarUsuario"
					...
					<div class="form-group">
						...
						<label for="Usuario">Usuario:</label> <input type="text"
							minlength="3" maxlength="20" name="usuario"
							style="border-radius: 5px;" required> <label for="Senha">Senha:</label>
						<input type="password" minlength="6" maxlength="30" name="senha"
							style="border-radius: 5px;" required> <label for="Nome">Nome:</label>
						<input type="text" name="nome_cliente" style="border-radius: 5px;"
							required> <label for="Cpf">Cpf:</label> <input
							type="text" name="cpf_cliente" style="border-radius: 5px;"
							required> <label for="Email">Email:</label> <input
							type="text" name="email_cliente" style="border-radius: 5px;"
							required> <label for="Telefone">Telefone:</label> <input
							type="text" name="tel_cliente" style="border-radius: 5px;"
							required> <input type="hidden" name="tipo" value="1" />
					</div>
